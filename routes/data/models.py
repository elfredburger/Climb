...
class Route(models.Model):
    ...
    coords=models.URLField(max_length=1000,verbose_name='Link to goole maps',help_text='Paste url with pin of the route from goole maps',null=True)
    extra_info=models.CharField(max_length=300,help_text='additional info about the route',null=True)
